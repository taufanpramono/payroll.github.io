...
<head>
    ...
    <title><?php echo $_SESSION['nama_karyawan'];?></title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
               <!--  <div class="sidebar-brand-icon rotate-n-15">
                ...
                <!--  <div class="sidebar-brand-text mx-3">SISFO PENGGAJIAN <sup>2</sup></div> -->
            </a>
            ...
            <li class="nav-item active">
                ...
                <!-- Nav Item - Pages Collapse Menu -->
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="?pages=slip-gaji">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['nama_karyawan'];?> <br/> <?php echo $_SESSION['nip'];  ?> </span>
              ...
              <!--   <a class="dropdown-item" href="#">
               ...
               <!--  <a class="dropdown-item" href="#">
                ...
                <a class="dropdown-item logout-data" href="action/logout.php" >
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">Apakah anda ingin mengakhiri season ini ?</div>
        <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
            <a class="btn btn-primary" href="module/logout.php">Keluar</a>
        </div>
    </div>
</div>
</div>
